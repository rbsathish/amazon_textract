...
class DocumentProcessor:
    ...
    def StoreInS3(self, response):
        ...
        # pdfTextExtractionS3ObjectName = self.document.replace('.jpg', '')
        if self.document.endswith('.pdf'):
            pdfTextExtractionS3ObjectName = self.document.replace('.pdf', '')
        if self.document.endswith('.jpg'):
            pdfTextExtractionS3ObjectName = self.document.replace('.jpg', '')
        if self.document.endswith('.png'):
            pdfTextExtractionS3ObjectName = self.document.replace('.png', '')
